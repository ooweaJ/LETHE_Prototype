# LETHE: 망각의 군주 HTML Alpha v0.10

현재 기획 원본은 `docs/LETHE_망각의_군주_프로토타입_기획서_v0_10.md`입니다. Word 버전은 `docs/LETHE_망각의_군주_완성형_기획서_v6.docx`에 같은 v0.10 내용으로 갱신되어 있습니다.

목표는 완성 게임이 아니라, HTML 프로토타입에서 “가장 의존한 기억을 망각 갈림길에서 직접 떠나보내고, 잔향 해금과 새 기억으로 피벗하는 경험”이 재미와 가능성을 갖는지 확인하는 것입니다.
...
- 목표: 보스/문지기를 처치한 뒤 망각 갈림길에서 떠나보낼 기억을 고르고, 결손 생존 후 새 기억으로 피벗하기
...
리포트의 Q1/Q2는 실제 인간 감정이 아니라 봇 기반 프록시입니다. 현재 v0.10은 갈림길/잔향 해금 구현 후 controlled 1-person browser playtest로 감정 반응을 확인할 단계입니다.
...
- `docs/LETHE_망각의_군주_프로토타입_기획서_v0_10.md`: 현재 기획 원본
...
- 결손 리듬: 결손 정비, 결손 압박
- 실시간 의존도 미터와 의존도 기반 망각 갈림길
- 망각 시 잔향 스탯과 새 피벗 경로 해금
- 75초 결손 생존 후 기억 보충
- 빌드 정체성/시너지 표시
