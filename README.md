# LETHE: 망각의 군주 HTML Alpha v0.9

현재 기획 원본은 `docs/LETHE_망각의_군주_프로토타입_기획서_v0.9.md`입니다. Word 버전은 `docs/LETHE_망각의_군주_완성형_기획서_v6.docx`에 같은 v0.9 내용으로 갱신되어 있습니다.

목표는 완성 게임이 아니라, HTML 프로토타입에서 “가장 의존한 기억을 잃고, 잔향과 새 기억으로 피벗하는 경험”이 재미와 가능성을 갖는지 확인하는 것입니다.
...
- 목표: 보스/문지기를 처치한 뒤 망각 질문에 답하고, 결손 생존 후 새 기억으로 피벗하기
...
리포트의 Q1/Q2는 실제 인간 감정이 아니라 봇 기반 프록시입니다. 현재 v0.9는 AI/browser gate 통과 후 controlled 1-person browser playtest를 준비하는 단계입니다.
...
- `docs/LETHE_망각의_군주_프로토타입_기획서_v0.9.md`: 현재 기획 원본
