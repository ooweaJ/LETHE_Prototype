...
- 2026-07-01 addendum: Hungry Blades was first wired as C/D, then changed to D-only after jaewoo feedback that D was not noticeable. Review D as the active orbit, bite hit, echo follow-up, and memory-gain read during the same replay.
