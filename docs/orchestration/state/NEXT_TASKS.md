...
- Include: `Dev_Prototype_v1`을 Play Mode로 열고 시작 무기 선택, 카드 선택 중 적 정지, 커진 쌍검 반달 2연 베기, 범위만큼 커진 얇은 대검 반달 베기, hitstop 중 캐릭터 이동감, 적 흰색 피격 플래시, 데미지 숫자, 원거리몹 정지 사격, 적 넉백/피격감, 칼무리 후속 반달타, 망각/공명/+5 잔향/피의 칼폭풍, HUD, 전투 밀도를 한 번에 확인한다.
