...
- Kalmuri review focus:
  ...
  - Play with audio on and judge whether Kalmuri lunge/pierce repetition is satisfying rather than tiring.
  - Check whether Blood Blade Storm, XP pickup, level-up, and utility-memory sounds sit at the right loudness.
